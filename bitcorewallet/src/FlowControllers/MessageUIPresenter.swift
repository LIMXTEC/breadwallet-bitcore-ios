...
class MessageUIPresenter: NSObject, Trackable {
    ...
    func presentEmailLogs() {
        ...
        emailView.setSubject("BTX Wallet Logs")
        emailView.setMessageBody("BTX Wallet Logs", isHTML: false)
        emailView.addAttachmentData(logData, mimeType: "text/plain", fileName: "btx_logs.txt")
