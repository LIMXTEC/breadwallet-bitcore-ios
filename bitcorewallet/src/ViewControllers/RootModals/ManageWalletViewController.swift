...
class ManageWalletViewController : UIViewController, ModalPresentable, Subscriber {
    ...
    private func setData() {
        ...
        // TODO:BCH
        self.textField.text = Currencies.btx.state.name
        let creationDate = Currencies.btx.state.creationDate
    ...
    func saveWalletName() {
        ...
        Store.perform(action: WalletChange(Currencies.btx).setWalletName(name))
    }
